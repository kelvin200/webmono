      ...
      <Switch>
        ...
        <Route path="/about">
          <article>
            ...
            <p>
              A tiny routing solution for modern React apps that relies on Hooks. A router you
              wanted so bad in your project!
            </p>
            <p>
              ...
              API and more traditional component-based API similar to React Router's one.
            </p>
            <p>
              <ul>
                <li>
                ...
                <li>
                  Mimics <a href="https://github.com/ReactTraining/react-router">React Router</a>
